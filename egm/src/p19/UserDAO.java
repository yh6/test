...
//
	...
	public int insertUser(HashMap<String,Object> hm) throws SQLException {
		String sql = "insert into user_info(uiname,uiage,uiid,uipwd,address,cino,uiregdate)/r/n"+
	                  "values(?,?,?,?,?,1,now())";
	
		PreparedStatement ps = con.prepareStatement(sql);
		ps.setString(1,(String)hm.get("uiname"));
		ps.setInt(2,(int)hm.get("uiager"));
	...
	public int updeteUser(HashMap<String,Object> hm) {
		return 0;
	}
	public int deletellser(int userNo) throws SQLException {
